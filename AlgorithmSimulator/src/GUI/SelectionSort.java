...
public class SelectionSort extends javax.swing.JFrame {
        ...
        public void run() 
        {
                ...
                for (int step = 0; step < 10-1; step++) 
                {
                    ...
                    if(step!=min)
                    {
                        ...
                        txtHighVal=TextBoxRef[step];
                        txtLowVal=TextBoxRef[min];


                        //interchange elements in textfields
                        txtTemp=TextBoxRef[step];
                        TextBoxRef[step]=TextBoxRef[min];
                        TextBoxRef[min]=txtTemp;

                        //create thread of animation instace
                        animationChange t=new animationChange();
                        t.start();
                        try {
                            ...
                            Logger.getLogger(SelectionSort.class.getName()).log(Level.SEVERE, null, e);
                        }
                    ...
                    //check if current element is equal to pivot
                    if(step==min)
                    {
                            ...
                            animationNotChage t1=new animationNotChage();
                            t1.start();
                            try {
    ...
    public class Descending extends Thread {
        ...
        public void run() 
        {
                //temporary variable to move elements between integer array indexes
                int temp ;
                ////temporary variable save minimum
                int min;
    ...
    public class animationChange extends Thread
    {
        ...
        public void run()
        {   
            //invoke pause method with overload
            goToSleep(1500);
            //color textbox
    ...
    public class animationNotChage extends Thread
    {
